        ...
        <app-container>
            <div class="header">
                ...
                <div class="header__wrapper">
                    ...
                    >
                        <nav class="menu">
                            <router-link to="/"><li class="menu__item">Головна</li></router-link>
                            <router-link to="/menu"><li class="menu__item">Меню</li></router-link>
                            <router-link to="/order"><li class="menu__item">Кошик</li></router-link>
                            <router-link to="/about"><li class="menu__item">Про нас</li></router-link>
                            <router-link to="/delivery"><li class="menu__item">Доставка</li></router-link>
                        </nav>
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            <router-link to="/"><li class="burger-menu__item">Головна</li></router-link>
                            <router-link to="/order"><li class="burger-menu__item">Кошик</li></router-link>
                            <router-link to="/about"><li class="burger-menu__item">Про нас</li></router-link>
                            <router-link to="/delivery"><li class="burger-menu__item">Доставка</li></router-link>
                            <router-link to="/contact"><li class="burger-menu__item">Контакти</li></router-link>
                        </nav>
                    </div>
                </div>
            </div>
...
<style lang="scss">
    ...
    .header {
        ...
        &__logo {
            width: 300px;
            height: 80px;
            background: url("./../assets/images/logoo.png");
