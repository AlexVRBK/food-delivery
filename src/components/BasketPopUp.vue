            ...
            <div class="basket__items">
                ...
                >
                    ...
                    <div class="basket__row">
                        ...
                        <div class="basket__item-price">{{ item.total }} грн</div>
                    </div>
                </div>
            </div>
            <div class="basket__finish-price">
                <div class="basket__finish-title">Разом</div>
                <div class="basket__price">{{ totalAmount }} грн</div>
            </div>
            <button class="basket__buy-order" 
...
export default {
    ...
    methods: {
         redirectToOrderPage() {
      this.$router.push('/order'); // Редирект на сторінку /order
    },
        removeProduct(id) {
